  ...
  return (
    <footer className="bg-primary-black text-primary-white pt-16 pb-6">
      <div className="container mx-auto max-w-7xl px-4">
        {/* Grid responsive: 1 col on mobile, 2 cols on md, 5 cols on lg */}
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="md:col-span-2 lg:col-span-1">
            ...
            <div className="relative">
              <input
                ...
                className="focus:ring-primary-red w-full rounded-md border border-gray-400 bg-transparent px-4 py-2 text-sm focus:ring-2 focus:outline-none"
              />
          ...
          <div>
            ...
            <div className="mb-4 flex gap-2">
              <div className="flex h-20 w-20 items-center justify-center rounded-md bg-white">
                <span className="text-xs text-black">QR Code</span>
              </div>
              <div className="flex flex-col gap-2">
                <div className="flex cursor-pointer items-center gap-1 rounded bg-white px-3 py-1 transition-opacity hover:opacity-80">
                  <svg
                    className="h-4 w-4"
                    viewBox="0 0 24 24"
                    fill="currentColor"
